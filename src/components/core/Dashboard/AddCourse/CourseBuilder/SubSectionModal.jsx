      ...
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800">
        ...
        className='space-y-8 px-8 py-10'>
          ...
          <div className="flex flex-col space-y-2">
            <label className='text-sm text-richblack-5 mt-5' htmlFor='lectureTitle'>Lecture Title{!view && <sup className="text-pink-200">*</sup>}</label>
            <input
          ...
          {/* Lecture Description */}
          <div className="flex flex-col space-y-2">
            <label className='text-richblack-5 text-sm'>Lecture Description{" "}
