...
const MyProfile = () => {
  ...
  return (
    <div>
      ...
      {/* section 1 */}
      <div className='flex sm:flex-row flex-col items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12'>
        <div className="flex flex-wrap items-center gap-x-4">
          ...
          <div className='space-y-1 items-center justify-center mt-2 mb-2'>
